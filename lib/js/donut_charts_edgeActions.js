...
// Thiago Passamani
var elements = [
    {instance:'box1', numbers:[502, 228, 274],    numberColors:['#61df1b', '#0ea800'], numberTexts:["",""], donutColors:["#61df1b","#61df1b"], donut2ndColors:["#0ea800","#0ea800"], text:'Demanda', textColor:'#fff', legendTitles: ['Anteriores','Novos']},
    {instance:'box2', numbers:[120, 65, 55],    numberColors:['#49dbe8','#3081b9'], numberTexts:["",""], donutColors:["#49dbe8","#49dbe8"], donut2ndColors:["#3081b9","#3081b9"], text:'Atendimento', textColor:'#fff', legendTitles: ['Andamento','Pendente']},
    {instance:'box3', numbers:[382, 111, 271],        numberColors:['#FA8072', '#FF0000'], numberTexts:["",""], donutColors:["#FA8072","#FA8072"], donut2ndColors:["#FF0000","#FF0000"], text:'Resolvidos', textColor:'#fff', legendTitles: ['Solucionados','Fechados']},

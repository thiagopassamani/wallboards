...
<script type="text/javascript" src="<?php echo WALLBOARDS_ROOT; ?>/lib/js/Chart.min.js"></script>
   	...
   	<div class="row">        	
     	<div id="logo" class="col-sm-3 col-lg-3">
     		<div class="half-unit">
				...
				<div class="thumbnail">
					...
					<br/>
					<p class="plugin-name"><?php echo __('Wallboards for GLPI','wallboards'); ?></p>
				</div>					
			</div><!-- LOGO -->
			<div class="half-unit">
		...
		<div id="view-global" class="col-sm-3 col-lg-3">
       		<div class="dash-unit">
       			...
       			<hr>
       			<canvas id="myLineChart" width="290"></canvas>
<script type="text/javascript">
...
var data = {
    ...
    datasets: [
        ...
        <div class="col-sm-3 col-lg-3">
			...
			<div class="half-unit">
	      		<dtitle>Meta de Atendimento Alcançado</dtitle>
	      		<hr>
	      		<div class="cont">
<?php
						...
						if($result_meta < $config_meta)
						{
							echo '<span class="meta-alcancada meta-red">'.$result_meta.'%</span>';
						}
						elseif($result_meta > $config_meta)
						{
							echo '<span class="meta-alcancada meta-green">'.$result_meta.'%</span>';
						}
						else
						{
						...
						echo '<br/>';
						echo '<span class="meta-atendimento-config">Objetivo '.$config_meta.'% de atendimento</span>';
?>
						</div>
					</div>
	     		<div class="half-unit">
